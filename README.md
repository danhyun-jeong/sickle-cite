...
최신 버전인 BETA 1.6.1 버전을 크롬 웹 스토어를 통해 브라우저에 바로 설치할 수 있습니다: [크롬 웹 스토어 링크](https://chromewebstore.google.com/detail/sickle-cite-beta/gcpfjpjfdocpojlfboppejoommfmhdlp)
...
여기에서는 BETA 1.6.1 버전의 패키지를 zip 파일 형태로 다운로드하여 설치할 수 있습니다.
